...
{
    public partial class AddCatalogItemDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterColumn<DateTime>(
                ...
                oldType: "datetime2",
                oldDefaultValue: new DateTime(2025, 2, 20, 14, 11, 42, 979, DateTimeKind.Local).AddTicks(9433));
            ...
            migrationBuilder.AlterColumn<DateTime>(
                ...
                oldClrType: typeof(DateTime),
                oldType: "datetime2",
                oldDefaultValue: new DateTime(2025, 2, 20, 14, 11, 42, 979, DateTimeKind.Local).AddTicks(8226));
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InsertTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2025, 2, 22, 13, 21, 8, 320, DateTimeKind.Local).AddTicks(5896)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InsertTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2025, 2, 22, 13, 21, 8, 320, DateTimeKind.Local).AddTicks(8342)),
                    IsRemoved = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    RemoveTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdateTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CatalogItemId = table.Column<int>(type: "int", nullable: false),
                    CatlogItemId = table.Column<int>(type: "int", nullable: false),
                    InsertTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2025, 2, 22, 13, 21, 8, 321, DateTimeKind.Local).AddTicks(78)),
                    IsRemoved = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    RemoveTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdateTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterColumn<DateTime>(
                ...
                type: "datetime2",
                nullable: false,
                defaultValue: new DateTime(2025, 2, 20, 14, 11, 42, 979, DateTimeKind.Local).AddTicks(9433),
                oldClrType: typeof(DateTime),
                oldType: "datetime2",
            ...
            migrationBuilder.AlterColumn<DateTime>(
                ...
                type: "datetime2",
                nullable: false,
                defaultValue: new DateTime(2025, 2, 20, 14, 11, 42, 979, DateTimeKind.Local).AddTicks(8226),
                oldClrType: typeof(DateTime),
                oldType: "datetime2",
